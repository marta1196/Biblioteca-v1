...
public class PrestamosTest {
	...
	public static void asignarValoresAtributos() {
		...
		Libro libro3 = new Libro("El alquimista", "Paulo Coelho", 224);
		Libro libro4 = new Libro("El alquimista", "Benjamin Jonso", 176);
	...
	private void prestarPrestamoValido(Prestamos prestamos, Prestamo prestamo) {
		try {
	...
	public void getDevuelvePrestamosOrdenadosPorFechaAlumnoLibro() {
		Prestamos prestamos = insertarOchoPrestamos();
		try {
	...
	private Prestamos insertarOchoPrestamos() {
		Prestamos prestamos = new Prestamos();
		prestarPrestamoValido(prestamos, prestamo1);
		prestarPrestamoValido(prestamos, prestamo2);
		prestarPrestamoValido(prestamos, prestamo3);
	...
	public void getEstadisticasMensualesPorCursoFechaValidaDevuelveCorrectamenteEstadisticasMensualesPorCurso() {
		...
		assertThat(PUNTOS_NO_ESPERADOS, estadisticasMensualesPorCurso.get(Curso.PRIMERO), is(19));
