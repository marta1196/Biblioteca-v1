...
public class LibrosTest {
	...
	public static void asignarValoresAtributos() {
		...
		libro4 = new Libro("El alquimista", "Paulo Coelho", 224);
		libro5 = new Libro("El alquimista", "Benjamin Jonso", 176);
	...
	private void insertarLibroValido(Libros libros, Libro libro) {
		try {
